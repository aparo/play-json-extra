...
import org.joda.time.chrono.ChronoZonedDateTime
import org.joda.time.format.DateTimeFormatter
import org.joda.time.temporal.{TemporalAccessor, TemporalAdjuster, TemporalAmount, TemporalField, TemporalUnit}
import com.zoepepper.facades.jsjoda.{ZoneOffset => ZoneOffsetF, ZonedDateTime => ZonedDateTimeF}
...
object ZonedDateTime {
  ...
  def of(localDateTime: DateTime, zone: ZoneId): ZonedDateTime = ZonedDateTimeF.of(localDateTime, zone)
  ...
  def ofLocal(localDateTime: DateTime, zone: ZoneId, preferredOffsetZoneOffset: ZoneOffset): ZonedDateTime =
...
class ZonedDateTime protected[time](f: ZonedDateTimeF) extends Wraps(f) with ChronoZonedDateTime[LocalDate] {
  ...
  def toLocalDateTime(): DateTime = f.toLocalDateTime()
